...
def window_total(conn: sqlite3.Connection, start: date, end: date, *, cardholder: str | None = None) -> int:
...
def monthly_totals(conn: sqlite3.Connection, *, cardholder: str | None = None) -> dict[str, int]:
